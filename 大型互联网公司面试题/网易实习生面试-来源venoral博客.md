...
pre-wrap 上面的pre很死板，超出盒子就超出，而pre-wrap意为格式化包裹，既能格式化又能让盒子包裹，所以是连续的空白符会被保留，在遇到换行符或者元素或者需要为了填充line盒子时才会换行。

![img](http://images2015.cnblogs.com/blog/861164/201603/861164-20160327110323339-894959475.png)

pre-line 连续的空格符会被合并，在遇到换行符或者元素或者需要为了填充line盒子时才会换行。这个更人性化了，注重格式化但更注重换行。
